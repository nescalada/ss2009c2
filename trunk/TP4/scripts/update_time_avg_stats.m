...
area_num_in_sys = area_num_in_sys + (num_in_q + server_status) * time_since_last_event;

costo_cliente_acumulado = costo_cliente_acumulado + num_in_q * time_since_last_event * costo_cliente;
costo_sistema_acumulado = costo_sistema_acumulado + time_since_last_event * costo_sistema;
