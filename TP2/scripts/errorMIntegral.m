...
legend('ki=0.00001','ki=0.0001','ki=0.001','ki=0.01');

xlabel('Tiempo(segundos)');
ylabel('Error relativo porcentual');
print -deps errorMIntegral.eps
